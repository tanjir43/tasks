            ...
            <x-card variant="primary" outline="true" title="{!! __('msg.city').' '.__('msg.list') !!}">
                <x-slot name="body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="event_request_table" style="width: 100%">
                            <thead>
                                <tr>
...
<script>
    $(function() {
        ...
        window.LaravelDataTables["dataTableBuilder"]=$("#event_request_table").DataTable({
            "serverSide":true,
            "processing":true,
            "ajax":{
                "url" : '{{route('event-request.datatable')}}',
                "type": "GET"
            },
            "columns":[
